...
public class Movimiento1 extends CameraActivity {
    ...
    public native void MovimientoResta1(long gris,long frameAnterior);
    ...
    private CameraBridgeViewBase.CvCameraViewListener2 cvCameraViewListener = new CameraBridgeViewBase.CvCameraViewListener2() {
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
            ...
            MovimientoResta1(CamaraGris.getNativeObjAddr(),CamaraColor.getNativeObjAddr());
            return CamaraGris;
        }
    };
    ...
    public void RegresarHJog(){
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toy = new Intent(Movimiento1.this,Menu2.class);
                startActivity(toy);
            }
        });
    }
