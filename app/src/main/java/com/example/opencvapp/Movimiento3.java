...
public class Movimiento3  extends CameraActivity {
    ...
    public native void MovimientoResta3(long gris,long frameAnterior);
    ...
    private CameraBridgeViewBase.CvCameraViewListener2 cvCameraViewListener = new CameraBridgeViewBase.CvCameraViewListener2() {
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
            ...
            MovimientoResta3(CamaraGris.getNativeObjAddr(),CamaraColor.getNativeObjAddr());
            return CamaraGris;
        }
    };
    ...
    public void RegresarHJog(){
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toy = new Intent(Movimiento3.this,Menu.class);
                startActivity(toy);
            }
        });
    }
