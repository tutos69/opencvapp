...
public class Movimiento2 extends CameraActivity {
    ...
    public native void MovimientoResta2(long gris,long frameAnterior);
    ...
    private CameraBridgeViewBase.CvCameraViewListener2 cvCameraViewListener = new CameraBridgeViewBase.CvCameraViewListener2() {
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
            ...
            MovimientoResta2(CamaraGris.getNativeObjAddr(),CamaraColor.getNativeObjAddr());
            return CamaraGris;
        }
    };
    ...
    public void RegresarHJog(){
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toy = new Intent(Movimiento2.this,Menu.class);
                startActivity(toy);
            }
        });
    }
